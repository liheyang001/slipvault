...
- **LLM Integration**: Use Claude API to structure raw OCR data into structured fields
...
- **LLM Usage**: Leverage Claude API with system prompts to reliably extract structured data from unstructured invoice text
